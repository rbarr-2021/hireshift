...
const workerLinks = [
  ...
  { href: "/dashboard/worker/messages", label: "Messages", mobileLabel: "Msgs" },
...
const businessLinks = [
  ...
  { href: "/dashboard/business/messages", label: "Messages", mobileLabel: "Msgs" },
        ...
        <aside className="panel h-fit p-4 sm:p-5 lg:sticky lg:top-4 lg:p-6">
          ...
          <Link href="/" className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm text-stone-400">Crew operating system</p>
            </div>
          </Link>
          <button
            type="button"
