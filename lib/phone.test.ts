...
describe("phone helpers", () => {
  it("normalises international numbers", () => {
    ...
    expect(normaliseInternationalPhoneNumber("44 7700 900123")).toBe("+447700900123");
    expect(normaliseInternationalPhoneNumber("07700900123")).toBe("+447700900123");
    expect(normaliseInternationalPhoneNumber("7700900123")).toBe("+447700900123");
  });
