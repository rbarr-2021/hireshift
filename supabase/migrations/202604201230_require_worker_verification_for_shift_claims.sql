...
declare
  ...
  worker_verification_status public.verification_status;
...
begin
  ...
  into worker_verification_status
  ...
  if worker_verification_status is distinct from 'verified' then
    raise exception 'Verify your identity before taking shifts';
  end if;
